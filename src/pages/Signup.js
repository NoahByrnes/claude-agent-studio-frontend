        ...
        `,
            ...
            backgroundPosition: 'center center'
                    ...
                    background: 'radial-gradient(circle at center, transparent 0%, rgba(10, 10, 10, 0.8) 100%)'
                                    ...
                                    color: '#666666',
                                    letterSpacing: '0.1em'
                                }, children: "SYS://REGISTER" }), _jsxs("h1", { className: "text-4xl font-bold mb-3", style: {
                                    fontFamily: "'IBM Plex Mono', monospace",
                                    color: '#FFFFFF',
                                ...
                                }, children: "Initialize new user account" })] }), _jsxs("div", { className: "p-8", style: {
                            ...
                            border: '1px solid #333333'
                                    ...
                                    borderBottom: '1px solid #333333'
                                            ...
                                            color: '#666666',
                                            letterSpacing: '0.1em'
                                        }, children: "CREATE ACCOUNT" }), _jsx("div", { className: "text-sm", style: {
                                            fontFamily: "'Archivo', sans-serif",
                                            color: '#CCCCCC'
                                        }, children: "Register credentials for system access" })] }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [error && (_jsx("div", { className: "p-3 text-sm", style: {
                                            ...
                                            fontFamily: "'Archivo', sans-serif"
                                                    ...
                                                    e.target.style.borderColor = '#333333';
                                                    e.target.style.boxShadow = 'none';
                                                }, required: true, autoComplete: "new-password", minLength: 6 })] }), _jsxs("div", { className: "space-y-2", children: [_jsx("label", { htmlFor: "confirmPassword", className: "block text-xs font-medium", style: {
                                                    fontFamily: "'IBM Plex Mono', monospace",
                                                    color: '#CCCCCC',
                                                    letterSpacing: '0.05em'
                                                }, children: "CONFIRM PASSWORD" }), _jsx("input", { id: "confirmPassword", type: "password", value: confirmPassword, onChange: (e) => setConfirmPassword(e.target.value), className: "w-full px-4 py-3 transition-all duration-150", style: {
                                                    fontFamily: "'Archivo', sans-serif",
                                                    backgroundColor: '#0A0A0A',
                                                    border: '1px solid #333333',
                                                    color: '#FFFFFF',
                                                    ...
                                                    e.target.style.borderColor = '#333333';
                                                    e.target.style.boxShadow = 'none';
                                                }, required: true, autoComplete: "new-password", minLength: 6 })] }), _jsx("button", { type: "submit", disabled: loading, className: "w-full px-6 py-3.5 font-medium transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed", style: {
                                            fontFamily: "'IBM Plex Mono', monospace",
                                        ...
                                        }, children: loading ? 'CREATING ACCOUNT...' : 'CREATE ACCOUNT' }), _jsx("div", { className: "pt-4", style: {
                                            borderTop: '1px solid #333333'
                                        }, children: _jsxs("p", { className: "text-center text-xs", style: {
                                                fontFamily: "'Archivo', sans-serif",
                                                color: '#666666'
                                            }, children: ["Already have an account?", ' ', _jsx(Link, { to: "/login", className: "font-medium transition-colors", style: {
                                                        color: '#FF6B35',
                                                        textDecoration: 'none'
                                                    }, onMouseEnter: (e) => {
                                                    ...
                                                    }, children: "Sign in" })] }) })] })] }), _jsx("div", { className: "mt-8 text-center text-xs", style: {
                            fontFamily: "'IBM Plex Mono', monospace",
                            color: '#333333',
                            letterSpacing: '0.1em'
